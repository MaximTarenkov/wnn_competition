...
class GRUInputEncodersMicroDeltaTwoHeads(nn.Module):
    def __init__(
        ...
        self.head_0 = nn.Linear(hidden_dim, 1)
        self.head_1 = nn.Linear(hidden_dim, 1)
...
def create_model(cfg) -> nn.Module:
    return GRUInputEncodersMicroDeltaTwoHeads(
